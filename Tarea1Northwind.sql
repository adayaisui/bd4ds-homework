...
case 
	when sum((od.unit_price-od.unit_price* od.discount)*od.quantity)> 100000 then 'Bueno'
	when sum((od.unit_price-od.unit_price*od.discount)*od.quantity)< 50000 then 'Malo'
	else 'Regular'
end as rating
